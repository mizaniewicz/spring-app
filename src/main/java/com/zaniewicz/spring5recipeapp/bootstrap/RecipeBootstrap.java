package com.zaniewicz.spring5recipeapp.bootstrap;

import com.zaniewicz.spring5recipeapp.domain.*;
import com.zaniewicz.spring5recipeapp.repository.CategoryRepository;
import com.zaniewicz.spring5recipeapp.repository.RecipeRepository;
import com.zaniewicz.spring5recipeapp.repository.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("www.przepisy.pl");
        ...
        tacosRecipe.setUrl("www.przepisy.pl");
